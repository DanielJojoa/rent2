...
<div class="container">
    <form id="formActualizaAutos" method="POST">
        ...
        <div class="md-form">
            <input required type="text" id="modelo" name="modelo" class="form-control" value="<?php echo $row['modelo'] ?>">
            <label for="modelo">Modelo</label>
        </div>

        <button type= "submit" class="btn btn-primary" onclick="actualizarAuto()" >Actualizar </button>
